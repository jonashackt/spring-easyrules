...
@Component // this should load configuration magically to the rules fields
@ConfigurationProperties(prefix = "rules") // this should load configuration magically to the rules fields
